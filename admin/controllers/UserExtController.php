...
use common\models\UserExtSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * UserExtController implements the CRUD actions for UserExt model.
 */
class UserExtController extends Controller
{
    ...
    {
        if (($model = UserExt::findOne(['id' => $id])) !== null) {
            return $model;
        }
